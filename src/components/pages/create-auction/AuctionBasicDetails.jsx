    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full min-h-32 px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent resize-vertical text-foreground bg-input"
          maxLength={2000}
        />
          ...
          <div className="bg-muted/50 rounded-lg p-3 border border-border">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-semibold text-foreground">
                S${parseFloat(formData?.reservePrice || 0)?.toLocaleString('en-SG', { minimumFractionDigits: 2 })}
              </span>
            </div>
            <div className="flex items-center justify-between text-sm mt-1">
              <span className="text-muted-foreground">Platform Fee (5%):</span>
              <span className="text-muted-foreground">
                S${(parseFloat(formData?.reservePrice || 0) * 0.05)?.toLocaleString('en-SG', { minimumFractionDigits: 2 })}
              </span>
            </div>
            <div className="border-t border-border mt-2 pt-2 flex items-center justify-between text-sm font-semibold">
              ...
              <span className="text-success">
                S${(parseFloat(formData?.reservePrice || 0) * 0.95)?.toLocaleString('en-SG', { minimumFractionDigits: 2 })}
              </span>
            </div>
          </div>
        )}
