        ...
        <div className="p-6">
          ...
          <div className="bg-muted/50 rounded-lg p-4 mb-6">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-medium text-foreground">S${selectedPlan?.priceAmount?.toFixed(2)}</span>
            </div>
            ...
            <div className="border-t border-border pt-3">
              <div className="flex items-center justify-between font-semibold text-foreground">
                <span>Total</span>
                <span>S${selectedPlan?.priceAmount?.toFixed(2)} SGD</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex space-x-3">
            ...
            <Button 
              ...
              iconPosition="left"
            >
              {processing ? 'Processing...' : `Pay S$${selectedPlan?.priceAmount?.toFixed(2)}`}
            </Button>
          </div>
        </div>
      </div>
