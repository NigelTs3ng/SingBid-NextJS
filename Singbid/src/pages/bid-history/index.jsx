                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <span className="font-semibold text-foreground">S${bid.bidAmount.toLocaleString()}</span>
                        </div>
                        <div>
                          <span className="text-muted-foreground block">Current High</span>
                          <span className="font-semibold text-foreground">S${bid.currentHighestBid.toLocaleString()}</span>
                        </div>
                        <div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">
                    S${bids.reduce((sum, bid) => sum + bid.bidAmount, 0).toLocaleString()}
                  </div>
