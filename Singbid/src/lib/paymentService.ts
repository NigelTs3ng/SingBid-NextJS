...
export class PaymentService {
  ...
  static async createSellerAccount(userId: string, email: string): Promise<{
    accountId: string
  ...
  static async processAuctionPayment(auctionId: string, winnerId: string): Promise<{
    success: boolean
    ...
    try {
      ...
      const sellerAccount = auction.seller_accounts
  ...
  static async handleFailedPayment(paymentIntentId: string, reason: string): Promise<void> {
    try {
      ...
      // Could also notify seller and buyer here
    } catch (error) {
  ...
  // Process refund
  static async processRefund(paymentId: string, reason: string): Promise<{
    success: boolean
    error?: string
  }> {
    try {
